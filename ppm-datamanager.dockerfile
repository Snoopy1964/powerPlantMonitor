...
COPY --from=0 /go/src/github.com/snoopy1964/powerPlantMonitor/datamanager /ppm-datamanager
# COPY --from=0 /go/src/github.com/snoopy1964/powerPlantMonitor/coordinator /coordinator
